...
import com.sum.server.frontend.FrontendFactory;
...
import com.sum.server.message.MessageType;

/**
 * <h1>Oracle</h1>
 * 
 * <p>
 * Compile or interpret a Oracle source program.
 * </p>
 */
public class Oracle {
	 ...
	 */
	public Oracle(String operation, String filePath, String flags) {
		try {
			boolean intermediate = flags.indexOf('i') > -1;
			boolean xref = flags.indexOf('x') > -1;
			source = new Source(new BufferedReader(new FileReader(filePath)));
			source.addMessageListener(new SourceMessageListener());
			parser = FrontendFactory.createParser("Oracle", "top-down", source);
	...
	private static final String USAGE = "Usage: Oracle execute|compile "
			+ FLAGS + " <source file path>";

	public static void main(String args[]) {

		new Oracle("Execute", "D:\\hello3.pas", "x");
	}
